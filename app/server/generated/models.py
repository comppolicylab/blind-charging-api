...
class AnonymousDocumentLink(BaseModel):
    attachmentType: Literal['LINK']
    url: AnyUrl
...
class AnonymousDocumentContent(BaseModel):
    attachmentType: Literal['BASE64']
    content: str


class AnonymousInputDocument(
    RootModel[Union[AnonymousDocumentLink, AnonymousDocumentContent]]
):
    root: Union[AnonymousDocumentLink, AnonymousDocumentContent] = Field(
        ...,
...
class ExtractionTarget(BaseModel):
    document: AnonymousInputDocument = Field(
        ...,
